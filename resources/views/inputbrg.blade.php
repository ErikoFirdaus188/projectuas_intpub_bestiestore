    ...
    <div class="content">
      <div class="container-fluid">
        <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ route('simpanbrg')}}" method="post">
                  {{ csrf_field() }}
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan ID Suplier" name="id_suplier">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="jenis" value="Lengan Panjang">
                          <label class="form-check-label">Lengan Panjang</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="jenis" value="Lengan Pendek">
                  ...
                  <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Harga</label>
                        <input type="number" class="form-control" placeholder="Harga Per Pcs"  name="harga" >
                      </div>
                    </div>
