...
<head>
  ...
  <title>Admin | Input Data Penjualan </title>
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ route('updatepenjualan', $penjualan->id)}}" method="post">
                {{ csrf_field() }}
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan ID Penjualan" name="id_jual" value="{{ $penjualan->id_jual }}">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan ID Barang" name="id_barang" value="{{ $penjualan->id_barang }}">
                      </div>
                    </div>
                  ...
                  <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>QTY</label>
                        <input type="text" class="form-control" placeholder="Masukkan Quantity" name="qty" value="{{ $penjualan->qty }}">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        <label>Harga</label>
                        <input type="text" class="form-control" placeholder="Masukkan Harga" name="harga" value="{{ $penjualan->harga }}">
                      </div>
                    </div>
