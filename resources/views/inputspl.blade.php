    ...
    <div class="content">
      <div class="container-fluid">
        <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ route('simpanspl')}}" method="post">
                {{ csrf_field() }}
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan ID Supplier" name="id_suplier" >
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Nama Supplier" name="nama_suplier">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- text input -->
