...
<head>
  ...
  <title>Admin | Input Data Supplier </title>
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ route('updatespl', $suplier->id)}}" method="post">
                {{ csrf_field() }}
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan ID Supplier" name="id_suplier" value="{{ $suplier->id_suplier }}">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Nama Supplier" name="nama_suplier" value="{{ $suplier->nama_suplier }}">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        <label>Alamat</label>
                        <input type="text" class="form-control" placeholder="Masukkan Alamat" name="alamat" value="{{ $suplier->alamat }}">
                      </div>
                    </div>
