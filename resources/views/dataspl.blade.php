            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  @foreach ( $dtsuplier as $itemspl )
                    <tr>
                      <td>{{ $itemspl->id_suplier }}</td>
                      <td>{{ $itemspl->nama_suplier }}</td>
                      <td>{{ $itemspl->alamat }}</td>
                      <td>
                        <a href="{{ url('editspl',$itemspl->id) }}" class="fas fa-edit"></a> | <a href="{{ url('deletespl',$itemspl->id) }}"class="fas fa-trash"></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
